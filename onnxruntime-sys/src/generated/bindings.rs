...
#[cfg(all(target_os = "android", target_arch = "x86_64", not(feature = "nnapi")))]
include!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/generated/android/x86_64/bindings.rs"
));

#[cfg(all(target_os = "android", target_arch = "aarch64", not(feature = "nnapi")))]
include!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/generated/android/aarch64/bindings.rs"
));

#[cfg(all(target_os = "android", target_arch = "x86_64", feature = "nnapi"))]
include!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/generated/android/x86_64/bindings_nnapi.rs"
));

#[cfg(all(target_os = "android", target_arch = "aarch64", feature = "nnapi"))]
include!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/generated/android/aarch64/bindings_nnapi.rs"
));
